...
/* dispatch.h: Header file for dispatch layer of Glk API, version 0.7.0.
...
/* The following functions are part of the Glk library itself, not the dispatch
    layer (whose code is in dispatch.c). These functions are necessarily
...
/* The following functions make up the Glk dispatch layer. Although they are
    ...
    their code is in dispatch.c, which is platform-independent and identical
