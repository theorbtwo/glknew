/* dispatch.c: Dispatch layer for Glk API, version 0.7.0.
...
static gidispatch_function_t function_table[] = {
    { 0x0001, NULL, "exit" },
    { 0x0002, NULL, "set_interrupt_handler" },
    { 0x0003, NULL, "tick" },
    { 0x0004, NULL, "gestalt" },
    { 0x0005, NULL, "gestalt_ext" },
    { 0x0020, NULL, "window_iterate" },
    { 0x0021, NULL, "window_get_rock" },
    { 0x0022, NULL, "window_get_root" },
    { 0x0023, NULL, "window_open" },
    { 0x0024, NULL, "window_close" },
    { 0x0025, NULL, "window_get_size" },
    { 0x0026, NULL, "window_set_arrangement" },
    { 0x0027, NULL, "window_get_arrangement" },
    { 0x0028, NULL, "window_get_type" },
    { 0x0029, NULL, "window_get_parent" },
    { 0x002A, NULL, "window_clear" },
    { 0x002B, NULL, "window_move_cursor" },
    { 0x002C, NULL, "window_get_stream" },
    { 0x002D, NULL, "window_set_echo_stream" },
    { 0x002E, NULL, "window_get_echo_stream" },
    { 0x002F, NULL, "set_window" },
    { 0x0030, NULL, "window_get_sibling" },
    { 0x0040, NULL, "stream_iterate" },
    { 0x0041, NULL, "stream_get_rock" },
    { 0x0042, NULL, "stream_open_file" },
    { 0x0043, NULL, "stream_open_memory" },
    { 0x0044, NULL, "stream_close" },
    { 0x0045, NULL, "stream_set_position" },
    { 0x0046, NULL, "stream_get_position" },
    { 0x0047, NULL, "stream_set_current" },
    { 0x0048, NULL, "stream_get_current" },
    { 0x0060, NULL, "fileref_create_temp" },
    { 0x0061, NULL, "fileref_create_by_name" },
    { 0x0062, NULL, "fileref_create_by_prompt" },
    { 0x0063, NULL, "fileref_destroy" },
    { 0x0064, NULL, "fileref_iterate" },
    { 0x0065, NULL, "fileref_get_rock" },
    { 0x0066, NULL, "fileref_delete_file" },
    { 0x0067, NULL, "fileref_does_file_exist" },
    { 0x0068, NULL, "fileref_create_from_fileref" },
    { 0x0080, NULL, "put_char" },
    { 0x0081, NULL, "put_char_stream" },
    { 0x0082, NULL, "put_string" },
    { 0x0083, NULL, "put_string_stream" },
    { 0x0084, NULL, "put_buffer" },
    { 0x0085, NULL, "put_buffer_stream" },
    { 0x0086, NULL, "set_style" },
    { 0x0087, NULL, "set_style_stream" },
    { 0x0090, NULL, "get_char_stream" },
    { 0x0091, NULL, "get_line_stream" },
    { 0x0092, NULL, "get_buffer_stream" },
    { 0x00A0, NULL, "char_to_lower" },
    { 0x00A1, NULL, "char_to_upper" },
    { 0x00B0, NULL, "stylehint_set" },
    { 0x00B1, NULL, "stylehint_clear" },
    { 0x00B2, NULL, "style_distinguish" },
    { 0x00B3, NULL, "style_measure" },
    { 0x00C0, NULL, "select" },
    { 0x00C1, NULL, "select_poll" },
    { 0x00D0, NULL, "request_line_event" },
    { 0x00D1, NULL, "cancel_line_event" },
    { 0x00D2, NULL, "request_char_event" },
    { 0x00D3, NULL, "cancel_char_event" },
    { 0x00D4, NULL, "request_mouse_event" },
    { 0x00D5, NULL, "cancel_mouse_event" },
    { 0x00D6, NULL, "request_timer_events" },
#ifdef GLK_MODULE_IMAGE
    { 0x00E0, NULL, "image_get_info" },
    { 0x00E1, NULL, "image_draw" },
    { 0x00E2, NULL, "image_draw_scaled" },
    { 0x00E8, NULL, "window_flow_break" },
    { 0x00E9, NULL, "window_erase_rect" },
    { 0x00EA, NULL, "window_fill_rect" },
    { 0x00EB, NULL, "window_set_background_color" },
#endif /* GLK_MODULE_IMAGE */
#ifdef GLK_MODULE_SOUND
    { 0x00F0, NULL, "schannel_iterate" },
    { 0x00F1, NULL, "schannel_get_rock" },
    { 0x00F2, NULL, "schannel_create" },
    { 0x00F3, NULL, "schannel_destroy" },
    { 0x00F8, NULL, "schannel_play" },
    { 0x00F9, NULL, "schannel_play_ext" },
    { 0x00FA, NULL, "schannel_stop" },
    { 0x00FB, NULL, "schannel_set_volume" },
    { 0x00FC, NULL, "sound_load_hint" },
#endif /* GLK_MODULE_SOUND */
#ifdef GLK_MODULE_HYPERLINKS
    { 0x0100, NULL, "set_hyperlink" },
    { 0x0101, NULL, "set_hyperlink_stream" },
    { 0x0102, NULL, "request_hyperlink_event" },
    { 0x0103, NULL, "cancel_hyperlink_event" },
#endif /* GLK_MODULE_HYPERLINKS */
#ifdef GLK_MODULE_UNICODE
    { 0x0120, NULL, "buffer_to_lower_case_uni" },
    { 0x0121, NULL, "buffer_to_upper_case_uni" },
    { 0x0122, NULL, "buffer_to_title_case_uni" },
    { 0x0128, NULL, "put_char_uni" },
    { 0x0129, NULL, "put_string_uni" },
    { 0x012A, NULL, "put_buffer_uni" },
    { 0x012B, NULL, "put_char_stream_uni" },
    { 0x012C, NULL, "put_string_stream_uni" },
    { 0x012D, NULL, "put_buffer_stream_uni" },
    { 0x0130, NULL, "get_char_stream_uni" },
    { 0x0131, NULL, "get_buffer_stream_uni" },
    { 0x0132, NULL, "get_line_stream_uni" },
    { 0x0138, NULL, "stream_open_file_uni" },
    { 0x0139, NULL, "stream_open_memory_uni" },
    { 0x0140, NULL, "request_char_event_uni" },
    { 0x0141, NULL, "request_line_event_uni" },
